...
def run(dbFilename):
  ...
  cursor.execute("""
        ...
        """)
  data_file = str(os.path.join(os.path.dirname(__file__),'..','..','dataset_movies_100M_fixed.csv'))
  ...
  cursor.execute("""
        ...
        WIND DOUBLE)
        """)
  data_file = str(os.path.join(os.path.dirname(__file__),'..','..','dataset_weather_100M_fixed.csv'))
  ...
  cursor.execute("""
        CREATE TABLE if not exists flights(
            ...
            FL_DATE TEXT)
        """)
  data_file = str(os.path.join(os.path.dirname(__file__),'..','..','dataset_flights_100M.csv'))
