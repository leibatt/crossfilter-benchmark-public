...
$psql_loc -U crossfilter --host=localhost -p $port -d crossfilter-eval-db -c "\\copy weather from '${root_dir}/dataset_weather_1M_fixed.csv' CSV HEADER;"
$psql_loc -U crossfilter --host=localhost -p $port -d crossfilter-eval-db -c "\\copy flights from '${root_dir}/dataset_flights_1M.csv' CSV HEADER;"
$psql_loc -U crossfilter --host=localhost -p $port -d crossfilter-eval-db -c "\\copy movies from '${root_dir}/dataset_movies_1M_fixed.csv' CSV HEADER;"
